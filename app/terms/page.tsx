export default function Terms() {
  return (
    <section className="flex flex-col gap-4 my-4">
      ...
      <h2 className="text-xl">AGREEMENT TO TERMS</h2>
      <p className="text-sm">
        These Terms of Use constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity (“you”) and Hemmelig
        Org (Company, we, us, or our), concerning your access to and use of the
        https://hemmelig.app website as well as any other media form, media
        ...
        Gramm-Leach-Bliley Act (GLBA). All users who are minors in the
        ...
        guardian to use the Site. If you are a minor, you must have your parent
      ...
      <h2 className="text-xl">PROHIBITED ACTIVITIES</h2>
      <p className="text-sm">
      ...
      <h2 className="text-xl">TERM AND TERMINATION</h2>
      <p className="text-sm">
      ...
      <h2 className="text-xl">LIMITATIONS OF LIABILITY</h2>
      <p className="text-sm">
        ...
        PAID, IF ANY, BY YOU TO US OR $1.00 USD. CERTAIN US STATE LAWS AND
      ...
      <h2 className="text-xl">INDEMNIFICATION</h2>
      <p className="text-sm">
